...
// 임시로 저장된 정보(tmp_name)
// $tempFile = $_FILES['imgFile']['tmp_name']; // "/private/var/folders/zz/zyxvpxvq6csfxvn_n000ckc40034l1/T/phpNw4Wvx"

// // 파일타입 및 확장자 체크
// $fileTypeExt = explode("/", $_FILES['imgFile']['type']); // image/jpeg

// // 파일 타입 
// $fileType = $fileTypeExt[0]; //image

// // 파일 확장자
// $fileExt = $fileTypeExt[1]; //jpeg
...
// 	if($extStatus){
// 		// 임시 파일 옮길 디렉토리 및 파일명
// 		$resFile = "./upload/{$_FILES['imgFile']['name']}"; // ./upload/hyoslee.jpeg
